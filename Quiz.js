$(document).ready(function(){
  ...
  // An array of javascript objects that includes quiz questions, descriptions, and multiple choice options
  QuestionSet=[{
  ...
  //Images with CL1 data attribute is the correct answer. This function shall check the selected answer and determine if it is the correct answer, add +1 to the overall score
  function Checking(){
  ...
  /*This function will display the next question, if the next question reaches the last question, it will
  ...
  //It will highlight the selected answer when user selects an option
  $(".Options").on("click","img",function(){
    $(".Options img").removeClass("Clicked");
    $(this).addClass("Clicked");
  });

  //When the button is clicked, it runs the Checking function to determine if the answer selected is correct and runs the DisplayNextQ function
